  ...
  render() {
    return (
      <div className="main-services">
        ...
        <p className="mission">
          Sound Insight starts with quality, taking to heart the needs of the
          customer first.
        </p>
        <p className="mission">
        ...
        <div className="services-wrapper">
          <section className="service">
            <NavLink to="/audio">
              <img
                src="https://i.imgur.com/iZ7e76p.jpg?1"
                alt="Speakers"
            ...
            <p className="service-desc">
              The best in both Analog and Digital Home Audio Systems
            </p>
          </section>
          <section className="service">
            <NavLink to="/video">
            ...
            <p className="service-desc">
              We work with all manufactures to insure the optimal video solution
              to fit your needs
            </p>
          </section>
          <section className="service">
            <NavLink to="/automation">
              <img
                src={require("../../assets/images/automation.jpg")}
                alt="iPad"
                className="service-img"
              />
              <h3>AUTOMATION</h3>
        ...
        <section className="store-info">
          ...
          <p className="showroom-info">
            Our showroom was built so that you can explore what is possible in
            Home Entertainment Technologies. We have dedicated Stereo and Home
